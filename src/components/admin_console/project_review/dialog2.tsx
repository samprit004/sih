    ...
    return (
        isOpen && (
            <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center">
                <div className="">
                    <div className="bg-white p-2 border-2 border-black h-full w-[900px] rounded-lg">
                        {/* Close Button */}
                        ...
                        <div className="flex  ml-6 p-2 items-center gap-10">
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <div className="flex items-center justify-center gap-2 w-36 h-7 border rounded-md border-black">
                                        <div className="h-5 w-5 border-2 rounded-md border-red-700 "></div>{' '}
                                        Fully Occupied
                                    </div>
                                    <div className="flex items-center justify-center gap-2 w-36 h-7 border rounded-md border-black">
                                        <div className="h-5 w-5 border-2 rounded-md border-green-700 "></div>{' '}
                                        Fully Available
                                    </div>
                                </div>
                                <div className="flex items-center justify-center gap-2 w-40 h-7 border rounded-md border-black mt-2 ml-14">
                                    <div className="h-5 w-5 border-2 rounded-md border-yellow-700 "></div>{' '}
                                    Partially Occupied
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                {availableSlots.length > 0 ? (
                                    <div className="flex gap-2">
                                        {availableSlots.map((slot, index) => (
                                            <button key={index} className="p-2 bg-gray-200 rounded mb-4">
                                                {slot}
                                            </button>
                                        ))}
                                    </div>
                                ) : (
                                    <div className="text-red-500 font-semibold mb-4">No slots available</div>
                                )}
                                ...
                                <table className="w-96 mb-4 border-2 border-black rounded-lg">
                                    <thead>
                                        <tr>
                                            <th className="border border-gray-300 p-2 bg-black text-white">
                                                Date
                                            </th>
