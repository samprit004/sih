...
const HNav = () => {
  ...
  return (
    <div className=' w-full top-0 left-0 z-10 border-b-2 border-black'>
      <div className="flex items-center justify-between bg-white px-5 py-4 ">
        ...
        <div className="flex flex-col gap-1 mr-[500px]">
          <h1 className="text-3xl font-semibold">Progress Highlights</h1>
          <p className="font-medium">
          Track all key updates, reports, and milestones submitted to date for this project.
          </p>
        </div>
