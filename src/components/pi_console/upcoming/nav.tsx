  ...
  return (
    <div className='fixed w-full top-0 left-0 z-10'>
      <div className="flex items-center justify-between bg-white px-5 py-4 ">
        ...
        <div className="flex flex-col gap-1 mr-[250px]">
          <h1 className="text-3xl font-semibold">Meetings & Submissions</h1>
          <p className="font-medium">
          Stay prepared for upcoming meetings by viewing scheduled dates, topics, and submitting necessary documents as requested.
          </p>
        </div>
